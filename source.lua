...
if not isfolder("kronos/Configs") then
    makefolder("kronos/Configs")
end

if not isfolder("kronos/Images") then
    makefolder("kronos/Images")
end
...
local library = {
    ...
    folders = {
        main = "kronos",
        assets = "kronos/Images",
        configs = "kronos/Configs"
    },
    shared = {
        initialized = false,
        fps = 0,
        ...
        for Index = 1, 10 do
            ...
            function item:Set(enabled, selected)
                ...
                if selected ~= nil then
                    ...
                    listitem_team.Color =  selected[3] == "None" and theme.textcolor or selected[3] == "Antilocking" and theme.accent or selected[3] == "Nigger" and theme.accent or theme.textcolor
...
function utility:UpdatePreview(Pass)
    if (kronos.Locals.Window and kronos.Locals.Window.isVisible and kronos.Locals.SelectedPage == "Players") or Pass then
        if kronos.Locals.SelectedPage and kronos.Locals.SelectedPlayersSection then
            local Size = {0, 0}
            local Selection = ("Players" .. kronos.Locals.SelectedPlayersSection .. "_")
            --
            if Flags[Selection .. "Chams"]:Get() then
                ...
                --
                local ChamsAuto = kronos.Locals.SelectedPlayersSection ~= "Local" and Flags[Selection .. "ChamsAuto"]:Get()
                ...
                --
                kronos.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Color", ChamsOutline, 1)
                kronos.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Transparency", 1 - ChamsOutlineTransparency, 1)
                kronos.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Color", ChamsAuto and ((kronos.Locals.Window.VisualPreview.Visible) and ChamsVisible or ChamsHidden) or ChamsFill, 2)
                kronos.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Transparency", 1 - (ChamsAuto and ((kronos.Locals.Window.VisualPreview.Visible) and ChamsVisibleTransparency or ChamsHiddenTransparency) or ChamsFillTransparency), 2)
            else
                kronos.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Transparency", 0, 1)
                kronos.Locals.Window.VisualPreview:SetComponentProperty("Chams", "Transparency", 0, 2)
            end
            --
            if Flags[Selection .. "Box"]:Get() then
                ...
                --
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("Box", "Box", "Color", BoxColor)
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("Box", "Box", "Transparency", 1 - BoxTransparency)
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("Box", "Outline", "Transparency", 1 - BoxTransparency)
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("Box", "Fill", "Color", BoxFillColor)
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("Box", "Fill", "Transparency", 1 - BoxFillTransparency)
            else
                kronos.Locals.Window.VisualPreview:SetComponentProperty("Box", "Transparency", 0)
            end
            --
            ...
            if Flags[Selection .. "HealthBar"]:Get() then
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("HealthBar", "Box", "Transparency", 1 - HealthBarTransparency)
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("HealthBar", "Outline", "Transparency", 1 - HealthBarTransparency)
                --
                Size[1] = 5
            else
                kronos.Locals.Window.VisualPreview:SetComponentProperty("HealthBar", "Transparency", 0)
            end
            --
            if Flags[Selection .. "HealthNum"]:Get() or Flags[Selection .. "HealthBar"]:Get() then
                kronos.Locals.Window.VisualPreview.Color1 = HealthBarColor
                kronos.Locals.Window.VisualPreview.Color2 = HealthBarColor2
                --
                kronos.Locals.Window.VisualPreview:UpdateHealthBar()
            end
            --
            if Flags[Selection .. "HealthNum"]:Get() then
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("HealthBar", "Value", "Transparency", 1 - HealthBarTransparency or 0)
                --
                kronos.Locals.Window.VisualPreview:UpdateHealthValue(Size[1])
            else
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("HealthBar", "Value", "Transparency", 0)
            end
            --
            if Flags[Selection .. "Name"]:Get() then
                ...
                --
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("Title", "Text", "Color", NameColor)
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("Title", "Text", "Transparency", 1 - NameTransparency)
            else
                kronos.Locals.Window.VisualPreview:SetComponentProperty("Title", "Transparency", 0)
            end
            --
            if Flags[Selection .. "Distance"]:Get() then
                ...
                --
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("Distance", "Text", "Color", DistanceColor)
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("Distance", "Text", "Transparency", 1 - DistanceTransparency)
            else
                kronos.Locals.Window.VisualPreview:SetComponentProperty("Distance", "Transparency", 0)
            end
            --
            if Flags[Selection .. "Tool"]:Get() then
                ...
                --
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("Tool", "Text", "Color", ToolColor)
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("Tool", "Text", "Transparency", 1 - ToolTransparency)
            else
                kronos.Locals.Window.VisualPreview:SetComponentProperty("Tool", "Transparency", 0)
            end
            --
            if Flags[Selection .. "Flags"]:Get() then
                ...
                --
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("Flags", "Text", "Color", FlagsColor)
                kronos.Locals.Window.VisualPreview:SetComponentSelfProperty("Flags", "Text", "Transparency", 1 - FlagsTransparency)
            else
                kronos.Locals.Window.VisualPreview:SetComponentProperty("Flags", "Transparency", 0)
            end
            --
            kronos.Locals.Window.VisualPreview:ValidateSize("X", Size[1])
        end
    end
end
--
utility:Connection(rs.Heartbeat, function()
    local Tick = tick()
    --
    if (Tick - kronos.Locals.LastPreviewUpdate) > 0.05 then
        utility:ThreadFunction(utility.UpdatePreview)
        kronos.Locals.LastPreviewUpdate = Tick
    end
end)
--

-- init configs
if isfolder("kronos/Configs") then
    for i,v in pairs(listfiles("kronos/Configs")) do
        table.insert(Library.Configs, v:split("\\")[2]:split(".")[1])
    end
else
    makefolder("konos/Configs")
end
...
--
kronos.Locals.ShiftTick = tick()
kronos.Locals.Shift = 0
--
function Library:CheckTeam(Player1, Player2)
...
--
function Library:GetHealth(Player, Character, Humanoid)
    if Humanoid then
...
--
function Library:ValidateClient(Player)
...
do -- utility
    ...
    function Library:RefreshConfigList()
        Flags["ConfigConfiguration_Box"].options = Library.Configs
        Flags["ConfigConfiguration_Box"]:Refresh()
        Flags["ConfigConfiguration_Box"].current = Clamp(Flags["ConfigConfiguration_Box"].current, 0, #Library.Configs)
    end
    --
    ...
    function Library:PerformConfigAction(ConfigName, Action)
        ...
        if ConfigName then
            if Action == "Delete" then
                local Found = Find(Library.Configs, ConfigName)
                --
                if Found then
                    delfile(("Library/Configs/%s"):format(ConfigName .. ".Library"), Config)
                    Remove(Library.Configs, Found) 
            ...
            elseif Action == "Save" then
                ...
                if Config then
                    ...
                    if not Find(Library.Configs, ConfigName) then
                        print("Config not found")
                        writefile(("Library/Configs/%s"):format(ConfigName .. ".Library"), Config)
                        table.insert(Library.Configs, ConfigName)
                        Library:RefreshConfigList()
                    end
                    --
                    writefile(("Library/Configs/%s"):format(ConfigName .. ".Library"), Config)
            ...
            elseif Action == "Load" then
                local Config = readfile(("Library/Configs/%s"):format(ConfigName .. ".Library"))
                local Table = Split(Config, "\n")
                local Table2 = {}
                --
                if Table[#Table] == "[ Library ]" then
                    Remove(Table, #Table)
                end
                --
                for Index, Value in pairs(Table) do
    ...
    function Library:UpdateHue()
        if (tick() - kronos.Locals.ShiftTick) >= (1 / 60) then
            kronos.Locals.Shift = kronos.Locals.Shift + 0.01
            --
            ...
            elseif Flags["ConfigTheme_AccentEffect"]:Get() == "Shift" then
                ...
                --
                Library:UpdateColor("Accent", Color3.fromHSV(Math:Shift(Hue + (Math:Shift(kronos.Locals.Shift) * (Flags["ConfigTheme_EffectLength"]:Get() / 360))), Saturation, Value))
            elseif Flags["ConfigTheme_AccentEffect"]:Get() == "Reverse Shift" then
                local Hue, Saturation, Value = Flags["ConfigTheme_Accent"]:Get():ToHSV()
                --
                Library:UpdateColor("Accent", Color3.fromHSV(Math:Shift(Clamp(Hue - (Math:Shift(kronos.Locals.Shift) * (Flags["ConfigTheme_EffectLength"]:Get() / 360)), 0, 9999)), Saturation, Value))
            end
            --
            kronos.Locals.ShiftTick = tick()
        end
    ...
    function utility:ThreadFunction(Func, Name, ...)
        local Func = Name and function()
            ...
            --
            if not Passed and not Library.Safe then
                warn("Library:\n", "              " .. Name .. ":", Statement)
            end
        end or Func
    ...
    function utility:SafeCheck(Text)
        ...
        --
        for Index, Value in pairs(kronos.Locals.BadWords) do Safe = Safe:gsub(Value, "_") end
        --
        return Safe
    end
    --
    ...
    function utility:MousePosition(Offset)
        if Offset then
            return UserInputService:GetMouseLocation() + Library:CursorOffset()
        else
